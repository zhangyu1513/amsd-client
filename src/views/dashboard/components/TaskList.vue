  ...
  <el-card shadow="hover" class="h-full">
    ...
    <div v-else class="space-y-2 max-h-100 overflow-y-auto pr-1">
      <div
        ...
        :key="index"
        class="group flex items-center gap-3 p-3 bg-gray-50 dark:bg-[#1d1d1d] rounded-lg border border-gray-100 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 transition-all cursor-pointer"
      >
